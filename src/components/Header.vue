<template>
    ...
    <div class="container-nav">
        ...
        <h1 class="container--title-mobile">M. T.</h1>
        
        <ul class="container--menu" :class="{active: isActive}">

            <li class="container--menu--list" @click="myFilter"><a class="container--menu--list--link" href="#about">login</a></li>
            <li class="container--menu--list" @click="myFilter"><a class="container--menu--list--link" href="#work">register</a></li>

        </ul>

        <div class="container--burgher-menu" @click="myFilter">
            <div class="line1"></div>
            <div class="line2"></div>
            <div class="line3"></div>
        </div>
