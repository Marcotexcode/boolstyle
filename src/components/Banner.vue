<template>
    ...
    <div class="container">
        ...
        <div class="information">
            ...
            <a href="#accept" class="btn" @click="ActiveLog = !ActiveLog">Scopri di piu</a>
            ...
            <div class="accept" id="accept" :class="(ActiveLog === true) ? 'active' : 'not-active'">
                ...
                <button class="btn btn-accept" @click="ActiveLog = !ActiveLog">Rifiuta</button>
                <button class="btn btn-accept" >Acconsento</button>
            </div>
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        padding:0;
        border-radius: 20px;
        background-image: url("../assets/ospitality.jpg");
